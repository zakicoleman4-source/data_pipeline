...
# still emit measurements; the PPK engine then makes its own call about
# which to use.
#
...
#                PPK solver will reject what it can't use.
KEEP_LEVEL_PRESETS = {
...
def process(measurement, model, fix_bias=True, timeadj=1e-7, pseudorange_bias=0.0,
    ...
    # GnssClock sanity check. Some budget Android phones (sm-a205u family
